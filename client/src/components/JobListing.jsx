...
const JobListing = () => {
  ...
  useEffect(
    ()=>{
      ...
      const matchesTitle=job=>searchFilter.length===""|| job.title.toLowerCase().includes(searchFilter.title.toLowerCase())
  ...
  return (
    <div className="container 2xl:px-20 mx-auto flex flex-col lg:flex-row max-lg:space-y-8 py-8">
      ...
      <div className="w-full lg:w-1/4 bg-white px-4">
        ...
        {/* location filter */}
        <div className={showFilter?"":"max-lg:hidden"}>
          <h4 className="font-medium py-4 text-lg pt-14">Search By Locations </h4>
          <ul className="space-y-4 text-gray-600">
     ...
     {/* job listng */}
      <section className="w-full lg:w-3/4 text-gray-800 max-lg:px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4">
           ...
           {filteredJobs.length>0 && (<div className="flex items-center justify-center mt-10 space-x-2">
              <a href="#job-list"><img onClick={() => setCurrentPage(Math.max(currentPage - 1,1))} src={assets.left_arrow_icon} alt="" />
</a>
