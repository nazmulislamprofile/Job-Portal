...
const Hero = () => {
    ...
    return (
        <div className='container 2xl:px-20 mx-auto my-10'>
            <div className='bg-gradient-to-r from-purple-800 to-purple-950 text-white py-16 rounded-xl mx-2 text-center'>
                ...
                <div className='flex justify-between items-center bg-white rounded text-gray-600 max-w-xl pl-4 mx-4 sm:mx-auto'>
                    <div className='flex items-center'>
                        <img className='h-4 sm:h-5' src={assets.search_icon} alt="serch-icon" />
                    ...
                    <button onClick={onSearch} className='bg-blue-600 m-1 px-6 py-2 rounded text-white'>Search</button>
                </div>
            </div>
            <div className='border border-gray-300 rounded-md shadow-md mx-2 mt-5 p-6 flex'>
